...
dans ce cas on va ajouter en fin de la liste(fin de file) et retirer au debut de la liste(debut de file)
on va implementer les fonctions on_cikar(retire devant) et arka_ekle(ajouter derierere)*/

/*pour la pile on ajoute devant et on retire devant pour avoir la structure last in first out
dans ce cas on va ajouter en debut de la liste(debut de pile) et retirer au debut de la liste(debut de pile)
